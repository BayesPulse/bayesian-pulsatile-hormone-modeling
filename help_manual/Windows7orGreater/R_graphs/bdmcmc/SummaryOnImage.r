...
graph <- function(count,burnin,commonFile,parmFile,mconFile,dataFile,graphLocation){
...
graph(iterator,burnin,commonFile,parmFile,mconFile,dataFile,graphLocation)
