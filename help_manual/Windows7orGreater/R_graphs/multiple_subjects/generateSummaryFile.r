...
##################################################################
 ...
 generateSummaryFile <- function(burnin,subjFile,subjid,graphSummaryLocation){
    ...
    path <- paste(graphSummaryLocation , "/IndSummary",subjid,".out",sep ='')
...
generateSummaryFile(burnin,subjFile,subjid,graphLocation) 
